...
export const SCHEMA_FORM_FIELDS: Record<string, FormField[]> = {
  ...
  fitness_activity: [
    ...
    { name: 'sport_type', label: 'Sport type', type: 'select', required: true, options: [
      ...
      { value: 'Walk', label: 'Walk' }, { value: 'Hike', label: 'Hike' },
      { value: 'Swim', label: 'Swim' }, { value: 'Workout', label: 'Workout' },
      { value: 'WeightTraining', label: 'Weight training' }, { value: 'Yoga', label: 'Yoga' },
      { value: 'Other', label: 'Other' },
    ]},
    { name: 'start_date', label: 'Date', type: 'date', required: true },
    { name: 'distance_km', label: 'Distance (km)', type: 'number' },
    { name: 'duration_min', label: 'Duration (minutes)', type: 'number' },
    { name: 'elevation_gain_m', label: 'Elevation gain (m)', type: 'number' },
    { name: 'average_heartrate', label: 'Average heart rate (bpm)', type: 'number' },
    { name: 'max_heartrate', label: 'Max heart rate (bpm)', type: 'number' },
    { name: 'calories', label: 'Calories', type: 'number' },
    { name: 'average_speed_kmh', label: 'Average speed (km/h)', type: 'number' },
  ],
  fitness_daily: [
    { name: 'date', label: 'Date', type: 'date', required: true },
    { name: 'steps', label: 'Steps', type: 'number' },
    { name: 'distance_km', label: 'Distance (km)', type: 'number' },
    { name: 'calories_out', label: 'Calories burned', type: 'number' },
    { name: 'floors', label: 'Floors climbed', type: 'number' },
